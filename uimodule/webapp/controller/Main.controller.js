...
sap.ui.define([
    ...
    "com/te/maps/resources/libs/maps",
    "sap/m/MessageBox",
    "sap/ui/model/json/JSONModel"
], function (Controller, maps, MessageBox, JSONModel) {
    "use strict";

    return Controller.extend("com.te.maps.controller.Main", {
        ...
        onfindingLocation: function (oPosition) {
            var oCoordinate = oPosition.coords;
            this.lattitude = oCoordinate.latitude;
            this.longitude = oCoordinate.longitude;
